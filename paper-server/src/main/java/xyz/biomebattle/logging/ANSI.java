...
public class ANSI {
    ...
    public ANSI(@NotNull String code) {
        this.code = code;
    }
    ...
    public static abstract class Color extends ANSI {
        ...
        protected Color(@NotNull String code, boolean isLight) {
            super(code);
    ...
    public static final class Foreground extends Color {
        ...
        Foreground(@NotNull String code, boolean isLight) {
            super(code, isLight);
        }
    }
    ...
    public static final class Background extends Color {
        ...
        Background(@NotNull String code, boolean isLight) {
            super(code, isLight);
        }
    }
    ...
    public static final class Style extends ANSI {
        ...
        public Style(@NotNull String code) {
            super(code);
        }
    }
}
